  ...
  return (
    <div className="min-h-screen bg-background py-24">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-5xl font-heading font-bold mb-4 bg-gradient-to-r from-primary to-orange-500 bg-clip-text text-transparent">
            Custom PC Builder
          </h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            {steps.map((step, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-card text-card-foreground rounded-2xl shadow-lg border-2 transition-all ${isActive
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <div className={`p-3 rounded-xl ${isComplete ? 'bg-green-100 dark:bg-green-900/30' : 'bg-primary/10'
                          }`}>
                          <Icon className={`w-6 h-6 ${isComplete ? 'text-green-600 dark:text-green-500' : 'text-primary'
                            }`} />
                        </div>
                        <div>
                          <h3 className="text-xl font-bold text-foreground flex items-center gap-2">
                            {step.type}
                            {!step.required && <span className="text-xs text-muted-foreground font-normal">(Optional)</span>}
                          </h3>
                      ...
                      {isComplete ? (
                        ...
                        <button
                          ...
                          className="px-6 py-2 bg-gradient-to-r from-primary to-orange-500 text-white rounded-lg font-semibold hover:shadow-lg transition"
                        >
                          Choose
                        </button>
                      )}
                    ...
                    {component.product ? (
                      <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-xl">
                        <Image
                          src={component.product.imageUrl || '/placeholder-product.png'}
                        ...
                        <div className="text-right">
                          <p className="text-xl font-bold text-primary">
                            LKR {component.product.price.toLocaleString()}
                          </p>
                          <button
                            onClick={() => {
                              const newBuild = [...build];
          ...
          <div className="space-y-6">
            ...
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              className="bg-card text-card-foreground rounded-2xl shadow-lg border border-border p-6 sticky top-24"
            >
              <h2 className="text-2xl font-bold text-foreground mb-6">Build Summary</h2>
                    ...
                    <div key={step.type} className="flex items-center justify-between text-sm">
                      ...
                      {comp.product ? (
                        <span className="font-semibold text-foreground">
                          LKR {comp.product.price.toLocaleString()}
                        </span>
                      ) : (
              ...
              {compatibilityIssues.length > 0 && (
                <div className="bg-destructive/10 rounded-xl p-4 mb-4 border-l-4 border-destructive">
              ...
              {allRequiredComplete && compatibilityIssues.length === 0 && (
                <div className="bg-green-500/10 rounded-xl p-4 mb-4 border-l-4 border-green-500">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3 bg-gradient-to-r from-primary to-orange-500 text-primary-foreground rounded-lg font-semibold hover:shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full py-3 border-2 border-primary text-primary rounded-lg font-semibold hover:bg-primary/10 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                ...
                <button
                  onClick={resetBuild}
                  className="w-full py-3 text-muted-foreground hover:text-foreground transition flex items-center justify-center gap-2"
                >
        ...
        {showModal && (
          ...
          >
            <motion.div
              ...
              className="bg-card text-card-foreground rounded-2xl shadow-2xl max-w-4xl w-full max-h-[80vh] overflow-hidden border border-border"
            >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {getAvailableProducts(steps[currentStep]?.type).map(product => (
                    <motion.div
                      ...
                      className="p-4 border-2 border-border rounded-xl hover:border-primary cursor-pointer transition bg-background"
                    >
                      <Image
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-semibold hover:bg-primary/90 transition flex items-center gap-1">
                          Select
