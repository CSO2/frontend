      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <motion.div
            ...
            className="bg-gradient-to-br from-wso2-orange to-wso2-orange-dark text-white rounded-2xl p-8"
          >
          ...
          <motion.div
            ...
            className="bg-gray-100 dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700"
          >
            <Award className="h-12 w-12 text-wso2-orange mb-4" />
        ...
        >
          {[
            ...
            >
              <stat.icon className="h-8 w-8 text-wso2-orange mx-auto mb-3" />
